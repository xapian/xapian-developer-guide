# -*- coding: utf-8 -*-
#
# Xapian developer guide build configuration file, created by
...
_project = u'Xapian developer guide'
_authors = u'Xapian Documentation Team & Contributors'
project = _project + version
copyright = u'2016 ' + _authors

github_project_url = 'https://github.com/xapian/xapian-developer-guide/blob/master'
...
htmlhelp_basename = 'XapianDeveloperGuide'
...
latex_documents = [
  ('index', 'XapianDeveloperGuide.tex', project,
   _authors, 'manual'),
]
...
# With the exception of setting highlight_language to C++ and turning
# off testing the examples, this is verbatim from the user guide.
